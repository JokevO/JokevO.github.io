...
Every action in these files are separated by `// ============`. When you do a selection by color range for example, this action can be found in `ScriptingListenerJS.log` and looks like this:
